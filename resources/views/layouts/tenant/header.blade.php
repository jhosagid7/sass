<header class="page-header row">
    <div class="logo-wrapper d-flex align-items-center col-auto p-0"><a href="/">
            <img class="light-logo img-fluid" src="{{ asset('assets/images/saas_pos_blanco_editado.png') }}" alt="logo"
                style="height: 60px!important" />
            <img class="dark-logo img-fluid" src="{{ asset('assets/images/saas_pos_blanco_editado.png') }}" alt="logo"
                style="height: 60px!important" /></a><a class="close-btn toggle-sidebar" href="javascript:void(0)">
            <svg class="svg-color">
                <use href="../svg/iconly-sprite.svg#Category"></use>
            </svg></a></div>
